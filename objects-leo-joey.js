...
//     const tax = Math.round(product.price * .07)
//     return `total price with tax is $${product.price + tax}`
// }
...
// console.log(lunch.ingredients.filter((value) => value === 'banana'))
// console.log(lunch.ingredients.filter((value, index) => index === 2))



// Write a function that takes the lunch object as an argument and returns "The ingredients for a PB and Banana sandwich are bread, peanut butter, and banana."
// const ingredient1 = (object) => {
//     return `The ingredients for a PB and Banana sandwich are ${object.ingredients}.`
// }
// console.log(ingredient1(lunch))
...
// const onlyNames = animals.name
// console.log(animals)

console.log(animals.filter((value, index) => index === 0))
